...
class Car {
    ...
    toggleAvailability(){
        this.isAvailable = !this.notAvailable
    }
}
let car = new Car ("toyota","brand",2020,true)
console.log({car})
...
class Rental {
    constructor(car,rentalName,rentalStartDate,rentalEnDate){
        this.car = car;
...
class Question {
    ...
    checkAnswer(answer){
        return answer === this.corrrectAnswer
    }
}
let question = new Question ("What is the name of your school?",'AkiraChix')
...
let quiz1=new Quiz()
let question1=new Question("Whats your name?",["Nancy","Akinyi","Ann"],"Saru")
let question2=new Question("Whats your school name?",["Nairobi University","Kitui University"],"AkiraChix")
quiz1.addQuestion(question1)
quiz1.addQuestion(question2)
quiz1.submitAnswer("Akinyi")
quiz1.nextQuestion()
quiz1.submitAnswer("Nairobi University")
